...
//                        println e ;
    ...
    String lostMS = null;
    try {
        lostMS = new StringBuffer(lostString.toString()).substring(lostString.indexOf('(') + 1, lostString.indexOf(')')).split("loss")[0].split("%")[0]
    } catch (ArrayIndexOutOfBoundsException e) {
        print "error:1024:$lostString"
        lostMS = "1"
    }
